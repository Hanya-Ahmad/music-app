...
//Functions to change css of heart icon
...
//Function to link the like icons of the same songs in different pages
function addLikeEventListener(likeIconElems){
    ...
    likeIcon.addEventListener('click',()=>{
		...
		if (parentNode.classList.contains('now-playing')){
			...
			//If the now playing song is displayed in the current page, like it there too
...
//This function makes a call to the Shazam API and returns the response
...
//This function adds a click event listener for all the songs displayed to be clickable
...
//Deactivate all pages other than the one displayed
